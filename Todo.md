...
* [ ] **7.1.** `lanshare-rs/src/main.rs` (Ana Daemon) içine gir. Storage, Network ve Discovery adaptörlerini burada ayağa kaldır (`new()` ile).
* [ ] **7.2.** Bu adaptörleri `lanshare-app` yöneticilerine (Dependency Injection ile) enjekte et.
